...
$htmlArray[] = CMyHtml::beginTabsChild(Yii::t('carrental', 'Renting order edit'), array_merge($tabsChildHtmlOptions, ['href'=>\yii\helpers\Url::to(['order/settlement', 'vehicle_id'=>$vehicleId, 'id'=>$orderId])]));

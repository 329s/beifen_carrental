...
$inputs = [
    ...
    ['type' => CMyHtml::INPUT_TEXTBOX, 'name' => $objForm->fieldName('mobile'),
        'label' => $objData->getAttributeLabel('mobile'),
    ...
    ['type' => CMyHtml::INPUT_TEXTBOX, 'name' => $objForm->fieldName('locator_device'),
        'label' => $objData->getAttributeLabel('locator_device'),
        'value' => $objData->locator_device,
        'htmlOptions' => [ 'required' => false, 'style'=>"width:200px"],
        'columnindex' => 2,
    ],

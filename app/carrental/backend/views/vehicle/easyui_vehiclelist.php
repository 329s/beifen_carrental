...
$urlInfo = ['vehicle/vehicle_list', 'action'=>$type];
...
$toolbarArray[] = CMyHtml::formatDatagridSearchAreaToolConfig(CMyHtml::DG_TOOL_SEARCH_DATEBOX, 'vehicle_change_time', '门店变更开始时间', '', ['searchOnChange'=>true]);

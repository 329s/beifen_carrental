...
$mileagePriceArrays = $objData->getMileagePriceInfo();
$arrMileageRanges = \common\components\VehicleModule::getVehicleMileagePriceRangesArray();
$mileageHtmls = [];
$mileageHtmls[] = yii\bootstrap\Html::beginTag('div', ['class'=>'input-group input-group-sm']);
foreach ($arrMileageRanges as $i => $r) {
    $mileageHtmls[] = yii\bootstrap\Html::tag('span', 
            isset($arrMileageRanges[$i+1]) ? ($r+1)."~{$arrMileageRanges[$i+1]}km" : ">{$r}km", 
                    ['class'=>'input-group-addon']);
    $mileageHtmls[] = yii\bootstrap\Html::input('number', $objForm->fieldName("mileage_price")."[{$r}]", 
            isset($mileagePriceArrays[$r]) ? $mileagePriceArrays[$r] : '', 
            ['class'=>'form-control required']);
}
$mileageHtmls[] = yii\bootstrap\Html::endTag('div');
...
$inputs = [
    ...
    // sjj
    ['type' => CMyHtml::INPUT_COMBOBOX, 'name' => $objForm->fieldName('radar'),
        'label' => $objData->getAttributeLabel('radar'),
        'value' => $objData->radar,
        'data' => common\models\Pro_vehicle_model::getYesOrNoArray(),
        'htmlOptions' => ['required' => true, 'editable'=>false, 'style'=>"width:200px"],
        'columnindex' => 1,
    ],
    ['type' => CMyHtml::INPUT_COMBOBOX, 'name' => $objForm->fieldName('carriage'),
        ...
        'data' => common\components\VehicleModule::getVehicleCarriagesArray(),
    ...
    // sjj
    ['type' => CMyHtml::INPUT_COMBOBOX, 'name' => $objForm->fieldName('chair'),
        'label' => $objData->getAttributeLabel('chair'),
        'value' => $objData->chair,
        'data' => common\models\Pro_vehicle_model::getChair(),
        'htmlOptions' => ['required' => true, 'editable'=>false, 'style'=>"width:200px"],
        'columnindex' => 1,
    ],
    ...
    ['type' => CMyHtml::INPUT_TYPE_GROUP],
    ['type' => CMyHtml::INPUT_TYPE_HTML, 'name' => $objForm->fieldName('mileage_price'),
    ...
    ['type' => CMyHtml::INPUT_IMAGEFIELD, 'name' => $objForm->fieldName('image_0'),
    ...
    ['type' => CMyHtml::INPUT_IMAGEFIELD, 'name' => $objForm->fieldName('image_a'),
    ...
    ['type' => CMyHtml::INPUT_IMAGEFIELD, 'name' => $objForm->fieldName('image_b'),
    ...
    ['type' => CMyHtml::INPUT_IMAGEFIELD, 'name' => $objForm->fieldName('image_d'),
    ...
    ['type' => CMyHtml::INPUT_IMAGEFIELD, 'name' => $objForm->fieldName('image_c'),
...
//    $objForm->fieldName('image_0') => $objData->image_0, 

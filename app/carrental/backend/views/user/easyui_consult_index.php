...
$canAdd = \Yii::$app->user->can('user/consult_add');
$canEdit = \Yii::$app->user->can('user/consult_edit');
$toolbarArray = [
    ...
    \Yii::$app->user->can('user/consult_delete') ? CMyHtml::formatDatagridToolConfig(CMyHtml::DG_TOOL_REMOVE, '', []) : null,

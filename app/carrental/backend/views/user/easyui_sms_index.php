...
$canAdd = \Yii::$app->user->can($type == \common\models\Pub_user_sms::TYPE_SENT ? 'user/sms_add' : 'user/smsrecv_add');
$canEdit = \Yii::$app->user->can($type == \common\models\Pub_user_sms::TYPE_SENT ? 'user/sms_edit' : 'user/smsrecv_edit');
$toolbarArray = [
    ...
    \Yii::$app->user->can($type == \common\models\Pub_user_sms::TYPE_SENT ? 'user/sms_delete' : 'user/smsrecv_delete') ? CMyHtml::formatDatagridToolConfig(CMyHtml::DG_TOOL_REMOVE, '', []) : null,

...
//    $tblColumns[] = 'detialed_info';
    $toolbarArray = [
        Yii::$app->user->can('options/vehicle_validation_options_add') ? CMyHtml::formatDatagridToolConfig(CMyHtml::DG_TOOL_APPEND, '', ['dialog'=>\yii\helpers\Url::to(['options/vehicle_validation_options_add'])]) : null,
        Yii::$app->user->can('options/vehicle_validation_options_edit') ? CMyHtml::formatDatagridToolConfig(CMyHtml::DG_TOOL_EDIT, '', ['dialog'=>\yii\helpers\Url::to(['options/vehicle_validation_options_edit']), 'needSelect' => true]) : null,
        Yii::$app->user->can('options/vehicle_validation_options_delete') ? CMyHtml::formatDatagridToolConfig(CMyHtml::DG_TOOL_REMOVE, '', ['dialog'=>\yii\helpers\Url::to(['options/vehicle_validation_options_delete']), 'needSelect' => true]) : null,

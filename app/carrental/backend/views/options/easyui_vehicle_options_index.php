...
if (backend\components\AdminModule::getAuthorizedOfficeId() == \common\components\OfficeModule::HEAD_OFFICE_ID) {
    $authOfficeName = \Yii::t('locale', 'Universal');
}
$htmlArray[] = CMyHtml::beginPanel(\Yii::t('locale', 'Currently settings would be effected as: {name}', ['name'=>$authOfficeName]));

    ...
    [
        ...
        'data'=> [
            [
                ...
                ['name'=>($objOrder->deposit_pay_source== \common\models\Pro_vehicle_order::PAY_TYPE_PRE_LICENSING?'预授权':'预授权'), 'nameen'=>'', 'value'=>floatval($objOrder->paid_deposit), 'namewidth'=>'90px'],
            ],
            [
                // ['name'=>'取车时间', 'nameen'=>'Pickup Date/Time', 'value'=>date('Y/m/d H:i', $objOrder->start_time), 'valuefontsize'=>'9px'],
                ['name'=>'取车时间', 'nameen'=>'Pickup Date/Time', 'value'=>date('Y/m/d H:i', $objOrder->yuyue_time), 'valuefontsize'=>'9px'],
            ...
            [
                ...
                ['name'=>'还车时间', 'nameen'=>'Dropoff Date/Time', 'value'=>date('Y/m/d H:i', $objOrder->yuyue_end_time), 'valuefontsize'=>'9px'],

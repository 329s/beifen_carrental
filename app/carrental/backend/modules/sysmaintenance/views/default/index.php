    ...
    [
        ...
        'data' => [
            [
                'name' => '手动修复数据',
                /*[
                    'name' => '修复缴费详单数据（缴费详单为新加功能，执行此步骤尝试修复老数据缺失情况）',
                    'icon' => 'icon-bug',
                    'type' => 'navTab',
                    'url' => \yii\helpers\Url::to(['default/fixpaymentdetail']),
                    'target' => $targetId,
                ],*/
                [
                    'name' => '修复升级车辆资费信息',
                    'icon' => 'icon-bug',
                    'type' => 'navTab',
                    'url' => \yii\helpers\Url::to(['default/upgradevehiclefeeplan']),
                    'target' => $targetId,
                ],
            ],
            [
                ...
                'icon' => 'icon-view',
                'type' => 'navTab',
                'url' => \yii\helpers\Url::to(['default/testui']),
                'target' => $targetId,
            ],
        ],
    ],
    [
        ...
        'data' => [
            [
                ...
                'icon' => 'icon-view',
                'type' => 'navTab',
                'url' => \yii\helpers\Url::to(['default/getorderchangelog']),
                'target' => $targetId,
            ],
            /*[
                'name' => '校验订单详单',
                'icon' => 'icon-view',
                'type' => 'navTab',
                'url' => \yii\helpers\Url::to(['default/checkorderdetail']),
                'target' => $targetId,
            ],*/
        ],
    ],

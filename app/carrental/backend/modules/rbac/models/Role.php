...
EOD
            ...
            'operation' => ['width' => 160, 
                'buttons' => [
                    ['type' => 'dialog', 'url' => \yii\helpers\Url::to(['rbac2/role_edit', 'id'=>'']), 'name' => \Yii::t('locale', 'Edit'), 'title' => \Yii::t('locale', 'Edit'), 'paramField' => 'id', 'icon' => 'icon-edit'],
                    ['type' => 'ajax', 'url' => \yii\helpers\Url::to(['rbac2/role_delete', 'id'=>'']), 'name' => \Yii::t('locale', 'Delete'), 'title' => \Yii::t('locale', 'Are you sure to delete these records?'), 'paramField' => 'id', 'icon' => 'icon-delete'],
                ],
            ],
        ];
        
        $authority = \backend\components\AdminModule::getCurRoleAuthoration();
        if ($authority >= static::AUTHORITY_DOMAIN_MANAGER) {
            $arrData['operation']['buttons'][] = ['type' => 'tab', 'url' => \yii\helpers\Url::to(['rbac2/role_column', 'id'=>'']), 'name' => '<font color=red>'. \Yii::t('locale', 'Manage authority') .'</font>', 'title' => \Yii::t('locale', 'Manage authority'), 'paramField' => 'id', 'icon' => ''];
        }

...
class Form_pro_vehicle extends \common\helpers\ActiveFormModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['vehicle_property', 'in', 'range' => [\common\models\Pro_vehicle::PROPERTY_BAUGHT, \common\models\Pro_vehicle::PROPERTY_AFFILIATE, \common\models\Pro_vehicle::PROPERTY_TRUSTTEE]],

 ...
 * Site controller
 */
class PuserController extends \yii\web\Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionEditinfo() {
        ...
        do
        {
            ...
            // $user = \common\models\Pub_user::findOne(['id' => 13436]);
            ...
            // $arrData['params'] = $params;
            // break;
            $requiredFields = ['name', 'card_type', 'card_id', 'phone', 'email'/*,'emergency_contact','emergency_telephone','home_address'*/];
            foreach ($requiredFields as $k) {
                if (!isset($params[$k])) {
                    $arrData['result'] = \frontend\components\ApiModule::CODE_INVALID_PACKAGE;
                    $arrData['desc'] = \Yii::t('locale', 'Missing required parameter!');
